#!/bin/bash
# Edit Bay Studio first-run installer.
...
osascript -e 'tell application "Terminal" to set custom title of selected tab of front window to "Edit Bay Studio Installer"' >/dev/null 2>&1 || true

echo ""
echo "  Installing Edit Bay Studio..."
echo ""
...
osascript -e 'tell application "Edit Bay Studio" to quit' >/dev/null 2>&1 || true
sleep 1
